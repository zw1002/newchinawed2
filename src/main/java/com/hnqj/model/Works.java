...
public class Works {
    ...
    public void setWorktypename(String typename){this.worktypename = typename == null ? "" : typename.trim(); }
    private String merchname;
    public  String getMerchname(){return  merchname;}
    public void setMerchname(String merchname){this.merchname = merchname == null ? "" : merchname.trim(); }
