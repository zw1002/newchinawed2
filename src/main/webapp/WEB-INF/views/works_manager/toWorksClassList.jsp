...
<script >
    ...
    function initTable(treeId) {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<%=basePath%>/worksClassMgr/getWorksClassList.do", //获取数据的Servlet地址
            striped: true,  //表格显示条纹
...
<div class=" style_border">
    ...
    <table id="cusTable" class="table">
        ...
        <tr>
            ...
            <th data-field="keyname" data-editable="false" align="center">分类名称</th>
            <th data-field="keyvalue" data-editable="false" align="center">分类代码</th>
            <th data-field="parentid" data-editable="false" align="center">上级分类</th>
            <th data-field="remarket" data-editable="false" align="center">分类说明</th>
        </tr>
        </thead>
    </table>
</div>
